...
namespace Game
{
	...
	public class TerrainChunkGeneratorProviderActive : ITerrainContentsGenerator
	{
		...
		public TerrainChunkGeneratorProviderActive(SubsystemTerrain subsystemTerrain)
		{
			...
			this.TGOceanSlope = 0.006f *(float)Math.Pow(2, 52);
			this.TGOceanSlopeVariation = 0.004f * (float)Math.Pow(2, 52);
			...
			this.TGMountainRangeFreq = 0.0006f * (float)Math.Pow(Math.PI, 3);
			this.TGMountainsPercentage = 0.15f;
			TerrainChunkGeneratorProviderActive.TGMountainsDetailFreq = 0.003f * (float)Math.Pow(2, 52);
			...
			this.TGTurbulenceFreq = 0.03f * (float)Math.Pow(2, 52);
			this.TGTurbulenceOctaves = 8;
			this.TGTurbulencePersistence = 0.5f;
			this.TGMinTurbulence = 0.04f * (float)Math.Pow(2, 52);
			this.TGTurbulenceZero = 0.84f * (float)Math.Pow(2, 52);
